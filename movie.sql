...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3918854074ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=movie&table=login">`movie`.`login`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=admin&table=user">`admin`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=admin&table=add_category">`admin`.`add_category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=movie&table=category">`movie`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=admin&table=category">`admin`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=workshop&table=lead">`workshop`.`lead`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gim&table=show_question">`gim`.`show_question`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gim&table=add_student_list">`gim`.`add_student_list`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gim&table=Add_student_list">`gim`.`Add_student_list`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project1&table=wp_users">`project1`.`wp_users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2d63366f377a746c622b75286d295174">
